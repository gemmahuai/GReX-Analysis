...
T3_path = '/home/user/zghuai/GReX-T3/T3/'
sys.path.append(T3_path)
import candproc_tools as ct
import analysis_tools_poetry as at
...
def plot_grex(cand, T0, tab, JSON): 
    ...
    window_time = 128 # number of samples in the downsampled window
...
if __name__ == '__main__':
    ...
    (cand, T0, tab) = gen_cand(v, fn_tempfil, fn_outfil, c+'.json')
